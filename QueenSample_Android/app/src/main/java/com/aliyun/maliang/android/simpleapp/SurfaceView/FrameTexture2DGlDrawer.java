...
public class FrameTexture2DGlDrawer {
    ...
    public FrameTexture2DGlDrawer()
    {
        ...
        int fragmentShader = loadShader(GLES20.GL_FRAGMENT_SHADER, TEXTURE2D_FRAGMENT_SHADER_CODE);
