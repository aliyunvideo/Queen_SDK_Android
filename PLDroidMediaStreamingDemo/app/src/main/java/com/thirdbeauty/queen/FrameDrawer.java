...
public class FrameDrawer {
    ...
    public FrameDrawer(boolean isOesTexture)
    {
    ...
    public void draw(float[] transformMatrix, int textureId, boolean isOesTexture) {
        if (mIsOesDrawer != isOesTexture) {
            // 需要重新更新
            initGLContext();
        }

        draw(transformMatrix, textureId);
    }
