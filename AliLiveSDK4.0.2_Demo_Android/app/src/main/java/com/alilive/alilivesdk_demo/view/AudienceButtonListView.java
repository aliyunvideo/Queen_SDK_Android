...
public class AudienceButtonListView extends FrameLayout {
    ...
    public AudienceButtonListView(@NonNull Context context) {
        this(context, null);
    }

    public AudienceButtonListView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AudienceButtonListView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initRecyclerView(View view) {
        ...
        LinearLayoutManager manager=new LinearLayoutManager(AudienceButtonListView.this.getContext());
        manager.setOrientation(LinearLayoutManager.HORIZONTAL);
        mRecyclerView.setLayoutManager(manager);
        mRecyclerView.setAdapter(mButtonListAdapter);
        mRecyclerView.addItemDecoration(new AnchorSpaceItemDecortation(DensityUtils.dip2px(getContext(),47),getContext()));
