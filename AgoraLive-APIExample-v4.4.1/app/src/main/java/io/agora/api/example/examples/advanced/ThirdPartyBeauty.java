...
import io.agora.api.example.examples.advanced.beauty.AliyunQueenBeauty;
import io.agora.api.example.examples.advanced.beauty.AliyunQueenBeautySDK;
...
//        SenseTimeBeautySDK.INSTANCE.initBeautySDK(requireContext());
        ...
        AliyunQueenBeautySDK.INSTANCE.initBeautySDK(requireContext());

        // Aliyun-Queen Beauty
        beautyActionIds.add(R.id.action_third_party_beauty_to_aliyun_queen);
        beautyLabels.add(getString(R.string.aliyun_queen_beauty));
